...
![Report Table](./data/fda_table.PNG){weight=40%}

![Overview Plot](../../images/projects/fda_validation/result_plot.PNG){height=30%}

![Detailed Plot](./data/fda_plot.PNG){height=30%}
...
![LSTM Confusion Matrix](./data/qc_confusion_matrix.png){width=50%}
...
* 통계분석: Linear regression, Logistic regression, Cox Proportional Hazards regression, Linear Mixed Effect Model, GWAS, Multiple Comparison Tests
...
* Sparse Partial Least Squares가 최적 성능의 분류기로 선정
