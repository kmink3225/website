...
* 목적: 장비 QC 프로세스를 고도화 및 자동화하여 QC의 정확도를 올린다.
* 기간: 2021.01 - 2021.09 (9 months)
* 역할: Project Manager & Data Scientist
* 참여 인원: 1명의 데이터 사이언티스트, 5명의 메카니컬 엔지니어, 4명의 생물학자, 1명의 변리사, 1명의 특허 실무자, 2명의 데이터 엔지니어, 3명의 full stack 개발자, 1명의 advisor
...
* 6억 원($450,000)에 달하는 QC 비용을 13배 감소
