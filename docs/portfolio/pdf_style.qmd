...
* 역할: Technical Lead & TF Team Manager (Data Scientist/ Data Engineering/ Governance Architect)
  * 2명의 Junior Data Scientist 멘토링: 문제정의, 통계 및 데이터 분석 역량 강화
  * 6명의 Data Engineer 멘토링: 데이터 거버넌스 70% 이해도 달성
...
* 시스템 구축 성과
  ...
  * 코드를 입력받아 LLM을 이용한 논리명 추천 시스템 구축
  * 용어 논리명을 입력받아 물리명 추천 시스템 구축
* 정성적 성과
