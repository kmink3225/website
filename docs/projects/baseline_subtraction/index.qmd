...
* 사내에 표준화된 baseline fitting 알고리즘이 없어 여러 알고리즘으로 baseline fitting 알고리즘이 존재한다. 
...
* 시각화 tool을 이용한 Baseline 알고리즘 개선
...
* **Rule-Based** 알고리즘 4 (rule-based): 팀원(물리학자)이 **Legacy** 알고리즘 1을 보완하기 위해 만든 알고리즘
* **Rule-Based+N**알고리즘 5 (rule-based): 팀원(물리학자)이 **Legacy** 알고리즘 1을 보완하기 위해 만든 n번째 알고리즘
* **ML** 알고리즘 6 (data-driven): 본인이 만든 data driven ML알고리즘
