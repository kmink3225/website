...
* 시스템 구축 성과
  ...
  * 자연어 처리를 활용한 용어별 도메인 그룹 분류 및 유사 용어 그룹핑
    ...
    * KoBERT(한글, 도메인 분류 정확도 95.65%), ALBERT(영어, 도메인 분류 정확도 99.1%)
    * 훈련 데이터: 총 5,632개 용어, 14개 도메인 그룹, 훈련/테스트 분할 4,505/1,127개
...
* 역할: Data Scientist & Project Lead
  ...
  * 유관 실무자 15명에 SW FDA 규제 문서 리뷰, 정리 및 지식 전파 
...
* 알고리즘 전용 FDA SW Validation Model 확립
...
![LSTM ROC Curve](./data/qc_roc_curve.png){width=35%}
...
![일부 GWAS 결과](./data/LLFS_gwas.PNG){width=25%}
