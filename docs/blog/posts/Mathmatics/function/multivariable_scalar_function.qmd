...
* $f(\mathbf x)=f(x_1,x_2)=x_1^2+x_1^2$, which can also be represented as $f(\mathbf x)=||x||^2=x_1^2+x_1^2$. When $g(\mathbf x)=g(x_1,x_2)=\sqrt{x_1^2+x_1^2}$, it is the trace of points equidistant from the origin on a plane.
