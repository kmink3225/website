...
* 세계에서 가장 엄격한 기준을 요구하는 미국의 FDA와 캐나다의 Health Canada의 surveilance 기준으로 진단 알고리즘의 안정성 검증 문서를 기획하고 작성한다.
...
* The safety verification document of the diagnostic algorithm is planned and prepared according to the surveilance standards of the US FDA and Canada's Health Canada, which require the most stringent standards among them.
