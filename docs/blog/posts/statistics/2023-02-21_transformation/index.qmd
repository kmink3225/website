...
$Y_1=X_1+X_2$ 와 $Y_2=X_1-X_2$ 의 결합 확률 분포를 구해라.
...
ax.plot(x,2*x-2,color='black',label=r'$y=2x-2$')
ax.plot(x,y2,color='red',label=r'$y=\frac{1}{2}x+1$')
ax.set_aspect(1)
ax.set_title(r"Transformation of Random Variables, $y=2x-2$ & $y=\frac{1}{2}x+1$")
...
ax.plot(x,y2,color='red',label=r'$y=\frac{1}{2}x+1$')
ax.set_aspect(1)
ax.set_title(r"Transformation of Random Variables, $y=2x+1$ & $y=\frac{1}{2}x+1$")
ax.set_xlabel("x-axis")
ax.set_ylabel("y-axis")
...
위의 그림을 보면 두 확률 변수 $X$ 와 $Y$ 의 관계가 $X$ 의 특정 구간에 대응되는 $Y$ 의 구간이 같다고 했을 때 $Y$ 의 확률 밀도는 $X$ 를 $b$ 만큼 이동한 확률 밀도의 $a$ 배가 된다. 
예를 들어, 위의 그래프의 경우, $y = 2x+1$ $(a>1)$ 일 때 $f_X(0<X<10)$ 는 $f_Y(1<Y<21)$ 의 density가 2배가 되는 것을 관찰 할 수 있다. 반대로, $y = \frac{1}{2}x+1$ $(a\le 1)$ 일 때 $f_X(0<X<10)$ 는 $f_Y(1<Y<6)$ 의 density가 $\frac{1}{2}$ 배가 된다.
